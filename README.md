<h1 align="center"> 🚀 Flexbox | Align-items </h1>
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/flexbox-align-items.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[Publicação em Codepen](https://codepen.io/cleibp/pen/PoBajmw) 
